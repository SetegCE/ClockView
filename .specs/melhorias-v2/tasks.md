...
- [x] 1. Agrupamento por projeto individual e remoção do sufixo " | SETEG"
...
- [x] 2. Seletor de período no header
...
- [x] 5. Legenda semáforo e correções visuais
