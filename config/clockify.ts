...
/** 
 * Usuários excluídos do dashboard (blacklist)
 * Todos os colaboradores ACTIVE da API do Clockify são exibidos automaticamente,
 * exceto aqueles listados aqui (não registram horas no Clockify)
 */
export const EXCLUDE_USERS = [
  "Eveline Mesquita",
  "Gustavo Toledo",
  "Matheus Haddad",
  "Hugo Fernandes",
